...
<link href="<c:url value="/resources/css/modifyForm.css" />" rel="stylesheet">
...
<div class="search-id">
	<div class="name">
	이름 :<br><input type="text" name="name" size="10" placeholder="이름을 입력해주세요" value="${member.name }"/>${nameMsg }<br/>
		</div>
		<div class="id">
		아이디 : <input type="text" readonly="readonly" class="form-control" id="id" name="id" size="10" value="${id }"/><br/>${pwMsg }
		</div>
		<div class="pw">
		비밀번호 : <input type="password" name="pw" placeholder="비밀번호를 재입력해주세요" size="20"/><br/>${pwMsg }<br/>
		</div>
		...
		<br/>
		<div class="add3">
		<input type="submit" class="btn1 btn-outline-success" value="수정하기"/>
		</div>
		</div>
</form>
</body>
