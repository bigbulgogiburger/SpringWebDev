...
<link href="<c:url value="/resources/css/joinForm.css" />" rel="stylesheet">
...
<script type="text/javascript">
	...
	<div class="mb-3 search-id mx-auto ">
		<div class="name">
		이름 : <input type="text" class="form-control" width="100px" placeholder="이름을 입력해주세요" name="name" size="10" value="${member.name }"/>${nameMsg }<br/>
